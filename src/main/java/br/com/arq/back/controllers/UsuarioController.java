...
public class UsuarioController {
	...
	@GetMapping(value = "/confirmasenha/{token}")
	public String sendmailAlteraSenha(@PathVariable String token) {
		try {
		Usuario resp = dao.findByToken(token); 
	...
	@RequestMapping(value = "/usuario/{id}", produces = "application/json", method = RequestMethod.POST)
